...
@section('content')
<h4 class="titulo">Editar Curso</h4>

<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{action('CursoController@update', $curso->id)}}">
                    {{csrf_field()}}
                    {{ method_field('PATCH') }}
                    <div class="form-group">
                        <label for="nombre" class="grey-text">Nombre</label>
                        <input type="text" id="nombre" name="nombre" value="{{$curso->nombre}}" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="costo_matricula" name="costo_matricula" value="{{$curso->costo_matricula}}" class="form-control{{ $errors->has('costo_matricula') ? ' is-invalid' : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="lugar" name="lugar" value="{{$curso->lugar}}" class="form-control{{ $errors->has('lugar') ? ' is-invalid' : '' }}">
                        @if ($errors->has('lugar'))
                            <span class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input id="fecha_inicio" name="fecha_inicio" value="{{$curso->fecha_inicio->format('Y-m-d')}}" class="form-control{{ $errors->has('fecha_inicio') ? ' is-invalid' : '' }}" width="230">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="capacidad" name="capacidad" value="{{$curso->capacidad}}" class="form-control{{ $errors->has('capacidad') ? ' is-invalid' : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="duracion" name="duracion" value="{{$curso->duracion}}" class="form-control{{ $errors->has('duracion') ? ' is-invalid' : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="profesor form-control{{ $errors->has('usuario_id') ? ' is-invalid' : '' }}" name="usuario_id">
                            @foreach($users as $user)
                                <option @if ($curso->usuario_id == $user->id) selected @endif value="{{$user->id}}">{{$user->nombre_completo}}</option>
                            @endforeach
                        </select>
